...
// **** the key is to escape on the way out not the way in, so your databse holds the values
// in their raw unpredictable form
...
// Make sure only public folder has public access
